      ...
      <div className="profile-card__left">
        <div className="profile-card__leftHeader">
          <Image
            src={
              avatarUrl ||
              "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=512&q=80&auto=format&fit=crop"
            }
            alt={`Avatar of ${name}`}
            width={128}
            height={128}
          ...
          <ul className="profile-card__socials">
            {socials.map((s, i) => (
              <li key={i} className="profile-card__social">
                <span
                  className="profile-card__social-badge"
                  aria-hidden="true"
                />
                <a
                  href={s.href}
                ...
                >
                  ...
                  {s.label && s.label.toLowerCase().includes("twitter") && (
                    <svg
                      ...
                      aria-hidden="true"
                    >
                      <path d="M23 4.56c-.8.36-1.66.6-2.56.71.92-.56 1.62-1.44 1.95-2.5-.86.52-1.8.9-2.8 1.1C18.7 2.5 17.54 2 16.3 2c-2.2 0-3.98 1.77-3.98 3.96 0 .31.04.61.1.9C8.1 6.7 4.3 4.8 1.67 1.65c-.34.6-.54 1.3-.54 2.04 0 1.4.71 2.63 1.8 3.36-.66-.02-1.28-.2-1.83-.5v.05c0 1.93 1.38 3.54 3.22 3.9-.34.09-.7.14-1.07.14-.26 0-.52-.02-.77-.07.52 1.62 2.03 2.79 3.82 2.83C6.2 17.6 4.4 18.3 2.5 18.3c-.34 0-.68-.02-1.01-.06 1.86 1.2 4.07 1.92 6.44 1.92 7.73 0 11.96-6.4 11.96-11.95 0-.18-.01-.36-.02-.54.82-.6 1.53-1.35 2.09-2.2z" />
                    </svg>
                  )}
